...
import { Plus, Heart, Leaf, Wind, Star, CheckCircle } from "lucide-react";
      ...
      <main className="px-4 pb-8">
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-2xl font-semibold text-white">Wellness Rituals</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <Button className="h-16 bg-green-500/20 hover:bg-green-500/30 border border-green-500/30 text-green-400 justify-start">
          ...
          <Button className="h-16 bg-blue-500/20 hover:bg-blue-500/30 border border-blue-500/30 text-blue-400 justify-start">
